...
public class GenData{
    ...
    public static HashMap<String,History> HH = new HashMap<>(65536);
    ...
    public static void genData(String src_path, String dst_path, boolean is_train) throws Exception{
        ...
        while((line = br.readLine()) != null){
            ...
            if(!HH.containsKey(fields[0])){
                HH.put(fields[0], new History());
            }
            History his = HH.get(fields[0]);
            if(his.prev_hour != hour){
                String tmp = (his.history + his.buffer);//先意思一下
